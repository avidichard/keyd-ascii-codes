...
# ABOUT
Makes it possible to use ALT+AsciiCode for the most popular French accentuated characters as well as a few other examples like space, enter, pipe, tilde and some special characters just for demonstration. These codes all use the universal standard ascii codes.
...
# EXTRA NOTES
These are small trade-offs when you move from Windows to linux but I made sure that the trade-offs were minimal and not too hard for your brain to adapt.
